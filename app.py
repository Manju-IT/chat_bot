...
# Disable Streamlit file watcher to prevent PyTorch issues
...
# Candidate data persistence functions
...
def handle_conversation(user_input):
    ...
    if st.session_state.current_step == "greeting":
        ...
        # Store question and answer with proper numbering
...
def main():
    ...
    # Show download button when data collection is complete
